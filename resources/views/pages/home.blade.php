...
<div
    id="TopNav"
    class="relative flex items-center justify-between px-5 mt-[60px]"
>
...
<div
    id="Categories"
    class="swiper w-full overflow-x-hidden mt-[30px]"
>
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide !w-fit pb-[30px]">
            <a href="categories.html" class="card">
                ...
                >
                    <div
                        class="w-[70px] h-[70px] rounded-full flex shrink-0 overflow-hidden"
                    >
                        <img
            ...
            <div class="swiper-slide !w-fit">
                <a href="details.html" class="card">
                    ...
                    >
                        ...
                        >
                            <img
                                src="{{ asset('storage/' . $boardingHouse->thumbnail) }}"
                                class="w-full h-full object-cover"
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <hr class="border-[#F1F2F6]" />
                            <p
                                class="font-semibold text-lg text-ngekos-orange"
                            >
                                Rp {{ $boardingHouse->price }}<span
...
<section
    id="Cities"
    class="flex flex-col p-5 gap-4 bg-[#F5F6F8] mt-[30px]"
>
...
<section id="Best" class="flex flex-col gap-4 px-5 mt-[30px]">
    ...
    <div class="flex flex-col gap-4">
        ...
        <a href="details.html" class="card">
            ...
            >
                <div
                    class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden"
                >
                    <img
                        src="{{ asset('storage/' . $boardingHouse->thumbnail) }}"
                        class="w-full h-full object-cover"
